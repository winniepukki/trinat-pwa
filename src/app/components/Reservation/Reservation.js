    ...
    render() {
        ...
        return <div className="reservation-form">
            <div className="reservation-form-wrapper">
                ...
                <div className="container">
                    ...
                    <div className="row custom-mg-25">
                        ...
                        <div className="col-sm-4">
                            ...
                            {
                                Object.values(t('reservation-items.people', { returnObjects: true })).map((item, index) => {
                ...
                <button onClick={this.props.handler} className="reservation-close-btn"><i className="far fa-times-circle"></i></button>
            </div>
        </div>
    }
}
