                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-sm-3">
                            ...
                            <p className="simple-text"><i className="fas fa-map-marker-alt"/>
                                <span>{this.props.address.line}</span></p>
                            <p className="simple-text"><i className="fas fa-phone-alt"/><a
                                href={'tel:' + this.props.phone}>{this.props.phone}</a></p>
                            <p className="simple-text"><i className="fas fa-at"/><a
                                href={'mailto:' + this.props.mail}>{this.props.mail}</a></p>
                            <p className="simple-text"><i className="fas fa-globe"/><span>{this.props.web}</span></p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul className="footer-links">
                                {
                                    Object.values(t('footer-menu', {returnObjects: true})).map((item, index) => {
                                        return <li key={index} className="footer-notice-text">
                                            <a href="#">{item}</a>
                                        </li>
                                    })
                                }
